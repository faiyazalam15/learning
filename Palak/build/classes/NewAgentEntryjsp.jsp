...
<tr>
	...
	<td><select name ="Rank">
			...
			<option value="2">[2] SR.EXECUTIVE</option>
			<option value="3">[3] DEVELOPMENT MANAGER</option>
			<option value="4">[4] REGIONAL MANAGER</option>
			<option value="5">[5] ZONAL MANAGER</option>
		</select>
	</td>
</tr>
<tr>
