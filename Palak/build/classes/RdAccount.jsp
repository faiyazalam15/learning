...
<body bgcolor="pink">
	...
	<script>
		function fdAccount() {
			var frm = "<center><table cellpadding='8' cellspacing='8' bgcolor='pink'><tr><td>Enter Maturity Amount</td><td><input type='text' id='fdmt' name='MatAmt'></td></tr><tr><td>Associate Code </td><td><input type='text' name='AgentCode' onkeyup='loadAssociateCode()'></td></tr><tr><td>Associate Name </td><td><input type='text' name='AgentName' id='d'></td></tr></table></center>";
