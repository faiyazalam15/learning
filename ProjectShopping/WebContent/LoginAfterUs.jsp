                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px;
                    ...
                    <div>
                        <div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;
                            ...
                            <br />
                            <span style="display: block; line-height: 1em; text-transform: uppercase; font-size: 52px;
                                color: #FFFFFF;">Best Services</span>
                            <br />
                            <br />
                            <span style="display: block; line-height: 1.1em; font-size: 2.5em; color: #FFFFFF;">
                               We provide you best 
...
<div id="search">
            ...
            <div class="col_4">
             ...
             <div class="col_1">
                ...
                <h3><a href="Search2.jsp?keyword=Mobiles">Mobiles</a></h3>
                <%
                Connection con=ConnectionProvider.getConnection();
                PreparedStatement pst=con.prepareStatement("select c_name from product where p_cat='Mobiles' group by c_name");
                %>
                <ul>
                <%
                ...
                {
                %>
                    <li><a href="showcomp1.jsp?val=<%=rs.getString(1)%>"><%=rs.getString(1) %></a></li>
                   <%
                }
                   %> 
                </ul>   
            ...
            <div class="col_1">
                ...
                <h3><a href="Search2.jsp?keyword=Laptops">Laptops</a></h3>
                <%
                PreparedStatement p=con.prepareStatement("select c_name from product where p_cat='Laptops' group by c_name");
                %>
                <ul>
                    <%
                ...
                {
                %>
                    <li><a href="showcomp1.jsp?val=<%=r.getString(1)%>"><%=r.getString(1) %></a></li>
                   <%
                }
                   %> 
            ...
            <div class="col_1">
                ...
                <h3><a href="Search2.jsp?keyword=Tablets">Tablets</a></h3>
          </div>
            ...
            <div class="col_1">
                ...
                <ul>
                    <li><a href="Search2.jsp?keyword=LCD">LCD</a></li>
                    <li><a href="Search2.jsp?keyword=Cameras">Cameras</a></li>
                    <li><a href="Search2.jsp?keyword=Headphones">Headphones</a></li>
                    <li><a href="Search2.jsp?keyword=MobileCases&Covers">Mobile Cases & Covers</a></li>
                </ul>   
                  ...
                  <li><a href="ShowCart1.jsp">
                 <%session=request.getSession();
                String uname=(String)session.getAttribute("uname");
                int c=0;
             PreparedStatement pppst=con.prepareStatement("select count(itemid) from cart where uname='"+uname+"'"); 
             ResultSet rrset=pppst.executeQuery();
           
             while(rrset.next())
            	 c=rrset.getInt(1);
             %><%=c%>  Show Cart</a></li>
                  <li><a href="OrderDetails.jsp">Your Orders</a></li>
                  <li ><a href="#" class="drop">My Accounts</a>
    			<div class="dropdown_1column ">
        		<div class="col_1">
                <ul class="simple">
                        <li><a href="UpAccUs.jsp">Update Account</a></li>
                        <li><a href="ChangePU.jsp">Change Password</a></li>
                    </ul>   
                </div>
                </div>
        		</li>
    	   	...
    	   	<div class="sidebar" style="margin-top: 40px;">
        		<div class="gadget">
         			 <h2 class="star"><span>Products</span></h2>
          			 ...
          			 <ul class="sb_menu">
       			     	<li><a href="Search2.jsp?keyword=Mobiles">Mobiles</a></li>
      			      	<li><a href="Search2.jsp?keyword=Home Appliances">Home Appliances</a></li>
      			      	<li><a href="Search2.jsp?keyword=Laptops">Laptops</a></li>
      			      	<li><a href="Search2.jsp?keyword=Networking">Networking</a></li>
        			  </ul>
        		</div>
        		<div class="gadget">
         			 <h2 class="star"><span>Company Name</span></h2>
         			 <%
         			 PreparedStatement ps=con.prepareStatement("select c_name from product group by c_name");
                ...
                {
                %>
                    <li><a href="showcomp1.jsp?val=<%=rst.getString(1)%>"><%=rst.getString(1) %></a></li>
                   <%
                }
                   %> 
