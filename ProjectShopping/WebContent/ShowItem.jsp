...
<%
 ...
 PreparedStatement prst = conn.prepareStatement("select * from product where p_id = '"+pid+"'");
...
<tr>
<td>
<img src="Search.jsp?val=<%=rslt.getString(4)%>" height="300" width="300"/><br/><br/></td>
<td>
...
<tr> 
<td>Price </td><td> <%=rslt.getString(7)%></td>
</tr>
<tr>
